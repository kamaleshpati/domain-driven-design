...
public class ExternalCargoRoutingService {
	...
	//TODO-2 uncomment the below lines to inject DiscoveryClient
    ...
    public CargoItinerary fetchRouteForSpecification(RouteSpecification routeSpecification){
    	...
    	//TODO-3 Uncomment the below lines to lookup eureka and get the uri using Discovery client api
    	...
    	*/
    	...
    	// TODO-4 modify the below REST_URI to use the above uri as base URL. HInt: See the below commented lines
        ...
        // = uri+"/cargorouting/optimalRoute?origin={origin}&destination={destination}&deadline={deadline}";
    	 ...
    	 System.out.println("ExternalCargoRoutingService.fetchRouteForSpecification()======hitting cargorouting service= using url "+REST_URI);
